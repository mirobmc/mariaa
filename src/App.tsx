...
const questions: Question[] = [
  ...
  { id: 147, text: "Escolha uma peça de roupa do parceiro e tire-a lentamente, mantendo contacto visual", type: "dare", spicy: true },
  { id: 148, text: "Sente-se no colo do parceiro durante 60 segundos sem falar", type: "dare", spicy: true },
  { id: 149, text: "Faça uma dança extremamente sensual para o parceiro, sem deixar que ele toque em você", type: "dare", spicy: true },
  { id: 150, text: "Beije lentamente o pescoço do parceiro e pare exatamente quando ele pedir para continuar", type: "dare", spicy: true },
  { id: 151, text: "Fique frente a frente com o parceiro, aproxime-se até quase se beijarem e mantenha a posição por 20 segundos", type: "dare", spicy: true },
  { id: 152, text: "Deixe o parceiro escolher uma parte do seu corpo que poderá beijar durante 15 segundos", type: "dare", spicy: true },
  { id: 153, text: "Tire uma peça de roupa sua de forma provocante, sem quebrar o contacto visual", type: "dare", spicy: true },
  { id: 154, text: "Deite-se ao lado do parceiro e faça uma provocação usando apenas olhar e linguagem corporal", type: "dare", spicy: true },
  { id: 155, text: "Sussurre no ouvido do parceiro exatamente o que gostaria que ele fizesse num encontro romântico", type: "dare", spicy: true },
  { id: 156, text: "Troquem de lugar e cada um deve tentar seduzir o outro durante 30 segundos", type: "dare", spicy: true },
  { id: 157, text: "Dê três beijos: um romântico, um inesperado e um extremamente provocante", type: "dare", spicy: true },
  { id: 158, text: "Aproxime-se por trás, abrace o parceiro e permaneça assim durante 30 segundos", type: "dare", spicy: true },
  { id: 159, text: "O parceiro escolhe uma peça de roupa que você deverá retirar lentamente", type: "dare", spicy: true },
  { id: 160, text: "Faça uma dança no colo do parceiro durante 30 segundos", type: "dare", spicy: true },
  { id: 161, text: "Escolha uma fantasia romântica sua e represente-a sem usar palavras", type: "dare", spicy: true },
  { id: 162, text: "Fiquem deitados frente a frente durante um minuto; quem quebrar o contacto visual primeiro deve dar um beijo", type: "dare", spicy: true },
  { id: 163, text: "Deixe o parceiro escolher onde receberá o próximo beijo, desde que seja uma área não íntima", type: "dare", spicy: true },
  { id: 164, text: "Finja que vocês acabaram de se conhecer num bar e tente conquistar o parceiro em 60 segundos", type: "dare", spicy: true },
  { id: 165, text: "Diga ao parceiro, olhando diretamente nos olhos: 'Se não estivéssemos a jogar, eu...' e termine a frase", type: "dare", spicy: true },
  { id: 166, text: "Escolham juntos uma peça de roupa para retirar e decidam quem fará isso", type: "dare", spicy: true },
...
function App() {
  ...
  const playerName = isPlayerOne ? "Txio Mirolas" : "Maria Celia";
